...
const UpdateBlog = () => {
    ...
    const card = location?.state?.detailCard;
    console.log(card)
    ...
    const handleUpdate = async (e) => {
        ...
        fetch(`http://127.0.0.1:8000/cards/update/${card?.id}`, requestOptions)
        ...
        <div className='w-100 d-flex align-items-center justify-content-center'>
            ...
            <Form className='w-50' onSubmit={handleUpdate}>
                ...
                <Form.Group className="mb-3 shadow-none" controlId="formBasicText">
                    ...
                    <Form.Control onChange={e => (SetTitle(e.target.value))} value={title} type="text" className='w-100' />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicText">
                    <Form.Label>Image URL</Form.Label>
                    <Form.Control onChange={e => (SetImage(e.target.value))} value={image} type="text" className='w-100' />
                </Form.Group>

                <Form.Group className="mb-5" controlId="exampleForm.ControlTextarea1">
                    <Form.Label>Content</Form.Label>
                    <Form.Control as="textarea" onChange={e => (SetContent(e.target.value))} value={content} rows={3} className='w-100' />
                </Form.Group>
